        ...
        switch (e.getActionCommand()) {
            ...
            case "Save":
                ...
                if(saveFile != null && saveFile.length() > 0) {
                    FileManager.writeFile(saveFile, Repository.getInstance().getShapes());
                }
                else {
            ...
            case "Load":
                ...
                if(loadFile != null && loadFile.length() > 0) {
                    Repository.getInstance().setShapes(FileManager.readFile(loadFile));
                    Repository.getInstance().getWorkingArea().repaint();
                }
                else {
